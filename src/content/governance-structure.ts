  ...
  architecture: {
    ...
    bridges: [
      ...
      },
      {
        ...
        type: "reporting",
        label: "Reporting to Student Governance",
      },
...
export const governanceNodes: GovernanceNodeData[] = [
  ...
  },
  {
    ...
    description: "A representative board felt by Students' Clubs & Societies and the Executive Committee across Universitas Mikroskil.",
    roles: ["Board oversight", "Representation", "Coordination"],
    responsibilities: [
      "Represent Students' Clubs, Societies, and the Executive Committee as a unified board.",
